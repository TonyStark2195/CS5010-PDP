...
public interface Maze {
  ...
  /**
   * This method is used to set the co-ordinates of the starting point location in the maze. This is
  ...
  /**
   * This method is used to set the co-ordinates of the goal point location in the maze. This is the
