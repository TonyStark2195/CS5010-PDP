...
public class Character {
   ...
   */
  public Character(CharacterType name, String description, int goldCoins) {
    this.name = name;
  ...
  /**
   * This method is used to get the number of arrows the character has.
   *
   * @return the number of arrows the character has
   */
  public int getWeapons() {
    return this.weapons;
  }

  /** This method is used to reduce the number of arrows the character has. */
